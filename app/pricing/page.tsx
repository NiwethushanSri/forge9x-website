        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {plans.map((plan) => (
              ...
              >
                {plan.highlight && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full text-xs font-bold text-white" style={{ backgroundColor: "#FFCC33" }}>
                    Most Popular
                  </div>
                )}
                ...
                <Link
                  href="/contact"
                  className={`py-3 rounded-xl font-semibold text-center transition-colors ${plan.highlight ? "bg-white hover:bg-gray-100" : "text-white hover:brightness-110"}`}
                  style={plan.highlight ? { color: "#00679A" } : { backgroundColor: "#00679A" }}
                >
                  {plan.cta}
                </Link>
              </div>
