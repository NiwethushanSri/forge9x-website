...
const mobileServices = [
  ...
  { icon: <Globe2 size={24} />, color: "#8AB17D", title: "Cross-Platform Development", desc: "Apps that work seamlessly across iOS, Android, and other operating systems. Reach a broader audience with one app on multiple platforms, reducing costs and improving reach." },
  { icon: <Building2 size={24} />, color: "#E9C46A", title: "Enterprise Mobility Solutions", desc: "We offer enterprise mobility solutions that allow companies to use cloud technology for secure access to company data, making remote work more efficient and productive." },
  { icon: <Star size={24} />, color: "#6FA8DC", title: "Best User Experience (UX)", desc: "We prioritise UX by thoroughly understanding your customers' needs, values, and limitations. Forge9x implements best practices to ensure a smooth, enjoyable experience aligned with your corporate goals." },
];
      ...
      <section className="bg-black border-t border-gray-800 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold text-white mb-4">Our Mobile Services</h2>
          </div>
      ...
      <section className="bg-black border-t border-gray-800 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-3">
            {process.map((step, i) => (
              <div key={step} className="flex items-center gap-4 bg-gray-900 rounded-xl p-4 border border-gray-800">
