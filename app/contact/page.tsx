            ...
            <div className="flex flex-col gap-6">
              ...
              {[
                ...
                <div key={item.label} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                  ...
                  {item.lines.map((line) => (
                    <div key={line} className="text-sm text-gray-500 ml-12">{line}</div>
                  ))}
                </div>
              ))}
            </div>
                  ...
                  <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="md:col-span-1">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                      />
                    </div>
                    <div className="md:col-span-1">
                    ...
                    <div className="md:col-span-1">
                      ...
                      <select
                        ...
                        className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 bg-white"
                      >
                    ...
                    <div className="md:col-span-1">
                      <label className="block text-sm font-medium text-gray-700 mb-1.5">Select Date for a Call</label>
                      <input
                        type="date"
                        value={form.date}
                    ...
                    <div className="md:col-span-1">
                      <label className="block text-sm font-medium text-gray-700 mb-1.5">Suitable Time</label>
                      <select
                        value={form.time}
                    ...
                    <div className="md:col-span-2">
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 resize-none"
                      />
                    </div>
                    <div className="md:col-span-2">
                      <button
